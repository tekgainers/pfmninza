...
@RestController
@RequestMapping("/api/all-in-one-pfm-kafka")
public class AllInOnePfmKafkaResource {

    private final Logger log = LoggerFactory.getLogger(AllInOnePfmKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public AllInOnePfmKafkaResource(KafkaProperties kafkaProperties) {
